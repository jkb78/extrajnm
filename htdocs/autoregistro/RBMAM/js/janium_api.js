// janium_api.js
/////
// Para uso exclusivo en la Red de Bibliotecas de Medellín Área Metropolitana
/////
//
...
var JaniumAPI={Version:'7.03',REQUIRED_PROTOTYPE:'1.5.1',KEY:'h6h8k-g537t-fx893-3t92u-kvmau',load:function(){function convertVersionString(versionString){var r=versionString.split('.');return parseInt(r[0])*100000+parseInt(r[1])*1000+parseInt(r[2]);}
if((typeof Prototype=='undefined')||(typeof Element=='undefined')||(typeof Element.Methods=='undefined')){document.write('<script type="text/javascript" src="js/prototype.js"></script>');}
else{if(convertVersionString(Prototype.Version)<convertVersionString(JaniumAPI.REQUIRED_PROTOTYPE)){throw("Para usar janium_api.js se require el framework de JavaScript 'Prototype' v. >= "+JaniumAPI.REQUIRED_PROTOTYPE);}}
document.write('<script type="text/javascript" src="js/janium_api_'+JaniumAPI.KEY+'.js"></script>');}}
JaniumAPI.load();
